...
public class SpiritVortex extends SpiritAbility {
	...
	public SpiritVortex(Player player) {
		super(player);
        ...
        boolean enabled = Spirits.plugin.getConfig().getBoolean("Abilities.Spirits.Neutral.SpiritVortex.Enabled");
        this.cooldown = Spirits.plugin.getConfig().getLong("Abilities.Spirits.Neutral.SpiritVortex.Cooldown");
        this.radius = Spirits.plugin.getConfig().getDouble("Abilities.Spirits.Neutral.SpiritVortex.Radius");
        this.pull = Spirits.plugin.getConfig().getDouble("Abilities.Spirits.Neutral.SpiritVortex.Pull");
        this.duration = Spirits.plugin.getConfig().getInt("Abilities.Spirits.Neutral.SpiritVortex.Duration");
        this.slowPower = Spirits.plugin.getConfig().getInt("Abilities.Spirits.Neutral.SpiritVortex.EffectAmplifier");
        this.effectDuration = Spirits.plugin.getConfig().getLong("Abilities.Spirits.Neutral.SpiritVortex.EffectDuration");
