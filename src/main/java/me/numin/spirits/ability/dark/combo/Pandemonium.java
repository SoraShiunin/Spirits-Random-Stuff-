...
public class Pandemonium extends DarkAbility implements ComboAbility {
	
	private static String path = "Abilities.Spirits.DarkSpirit.Combo.Pandemonium.";
	...
	public Pandemonium(Player player) {
		...
		boolean enabled = config.getBoolean("Abilities.Spirits.DarkSpirit.Combo.Pandemonium.Enabled");
