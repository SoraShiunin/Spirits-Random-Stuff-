...
*/
        ...
        */
        ...
        config.addDefault("Abilities.Spirits.LightSpirit.Passive.WishfulThinking.Chance", 33);
        ...
        config.addDefault("Abilities.Spirits.DarkSpirit.Passive.SinisterAura.Chance", 33);
